...
const TradingViewScreener = memo(() => {
  ...
  useEffect(() => {
    ...
    // Setting disesuaikan persis dengan gambar referensi ke-2 Anda
    script.innerHTML = `
      {
        "width": "100%",
        "height": "100%",
  ...
  return (
    <div className="bg-[#121212] border border-[#2d2d2d] rounded-xl flex-1 w-full h-full shadow-lg relative overflow-hidden custom-tv-scroll">
      
      {/* INJEKSI CSS KHUSUS SCROLLBAR ELEGAN (Opsional: agar menyatu dengan tema) */}
...
export default function ScreenerPage() {
  return (
    <div className="flex flex-col h-[calc(100vh-42px)] p-4">
      <TradingViewScreener />
    </div>
  );
}